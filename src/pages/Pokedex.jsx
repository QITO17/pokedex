  ...
  return (
    <section className="min-h-screen pb-[30px] ">
      ...
      <section className="py-6 px-2">
        <h3 className="flex gap-2"><p className="text-red-500 flex">Welcome </p> {nameTrainer}, here you can find your favorite pokemon
        </h3>
        <p className="fixed top-[10px] z-10 "><i className='bx bxl-react text-blue-400'></i><i className='bx bxl-javascript text-yellow-400'></i>
        <i className='bx bxl-html5 text-orange-500'></i><i className='bx bxl-css3 text-blue-400'></i></p>
      ...
      <section className="grid  gap-6 px-2 grid-cols-[repeat(auto-fill,_270px)] auto-rows-auto  justify-center
